# Django settings for dash_proj project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dash_dev.db',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(PROJECT_ROOT, 'static_root', 'static')
...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_ROOT, 'gitawesome', 'static'),
)
...
SECRET_KEY = 'ib&ha7=7j$dudw37&42+7me9=6di@y3so&ix8!2iet@_m&o)ol'
