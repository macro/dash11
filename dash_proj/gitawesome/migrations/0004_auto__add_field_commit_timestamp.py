...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Commit.timestamp'
        db.add_column('gitawesome_commit', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 30, 23, 52, 1, 599192)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Commit.timestamp'
        db.delete_column('gitawesome_commit', 'timestamp')
