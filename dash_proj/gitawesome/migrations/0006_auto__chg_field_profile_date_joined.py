...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('gitawesome_profile', 'date_joined', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Profile.date_joined'
        raise RuntimeError("Cannot reverse this migration. 'Profile.date_joined' and its values cannot be restored.")
